...
//      $this->email->initialize($config);  
   ...
   //   $this->load->http();
    ...
    public function GetEquipment($data){
        try{
            $sql = "SELECT ALTag, Location, User, Status, "
                ."Type, Make, Model, Serial_No, Tag_No, "
                ."Computer_Name, OS, if(Std_Image,'Y','N') as Std_Image, "
        ...
        try{
            ...
            if(isset($data['ALTag']) AND $data['ALTag']!=""){
                $sql = "UPDATE computers SET "
                    ...
                    ."Make = '".$data['txtMake']."', "
                    ."Model = '".$data['txtModel']."', "
                    ."Serial_No = '".$data['txtSerial_No']."', "  
                    ."Tag_No = '".$data['txtTag_No']."', "
                    ."Computer_Name = '".$data['txtComputer_Name']."', "
                    ."OS = '".$data['txtOS']."', "
                ...
                $sql = "INSERT INTO computers ("
                    ...
                    .") values ("
                    ."'".$data['txtLocation']."', '".$data['txtUser']."', '".$data['txtStatus']."',"
                    ."'".$data['txtType']."', '".$data['txtMake']."', '".$data['txtModel']."', "
                    ."'".$data['txtSerial_No']."', '".$data['txtTag_No']."', "
                    ."'".$data['txtComputer_Name']."', "
                    ."'".$data['txtOS']."', "
                    .($data['txtStd_Image']=='Y'?1:0).", "
                    .($data['txtITS']=='Y'?1:0).", "
                    ."'".$data['txtDescription']."', '".$data['txtNotes']."', "
                    ."YEAR(NOW()), NOW(), "
                    ."'".$UserData['user']."'  "
                    .")";
            }
