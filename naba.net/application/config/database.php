...
$db['pdo']['hostname'] = 'localhost';
$db['pdo']['username'] = 'admin';
$db['pdo']['password'] = 'uMfa13Zov';
$db['pdo']['database'] = 'aldb';
$db['pdo']['dbdriver'] = 'pdo';
$db['pdo']['dbprefix'] = '';
$db['pdo']['pconnect'] = FALSE; // Was TRUE;
...
$db['pdo']['dsn'] = 'mysql:host=localhost; dbname=aldb; charset=utf8;';
...
$db['pdo2'] = array(
    ...
    'autoinit' => TRUE,
    'stricton' => FALSE,
    'dsn' => 'mysql:host=localhost; dbname=aldb; charset=utf8;'
);