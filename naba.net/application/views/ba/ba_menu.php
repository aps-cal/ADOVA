...
if(isset($UserStatus)   
   and ($UserStatus=='Admin' 
      ...
      <li class="<?=($NextPage=='ba/attendace'?'current-page ':'');?>site-root rendered-link" > 
         <div class="link-content"> 
            <a href="/ba/attendance" data-page-url="/ba/attendace"> 
               <div class="title rendered-link-content">Attendance </div> 
               <div class="separator rendered-link-content"></div> 
            </a>
         </div>
      </li>
      <li class="<?=($NextPage=='ba/monitoring'?'current-page ':'');?>site-root rendered-link" > 
         <div class="link-content"> 
            <a href="/ba/monitoring" data-page-url="/ba/monitoring"> 
               <div class="title rendered-link-content">Monitoring </div> 
               <div class="separator rendered-link-content"></div> 
            </a>
         </div>
      </li>
