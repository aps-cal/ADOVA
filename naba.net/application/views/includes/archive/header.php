...
<html lang="en-GB" >
  <head >
    ...
    <link rel="stylesheet" href="/styles/standard.css" type="text/css">
     ...
     <link rel="stylesheet" href="/styles/naba.css" type="text/css">
...
if(isset($UserStatus) and !$UserStatus == ''){
   echo '<a href="/login/logout.php"><span style="color:white; font-size:14px; font-weight: bolder; text-decoration:none;">Logout</span></a>';
} else {
    echo '<a href="/login/login.php"><span style="color:white; font-size:14px; font-weight: bolder; text-decoration:none;">Login</span></a>';
}?>
</ul>
</div>
</div>
