...
<html lang="en-GB" >
  <head >
    <base href="/">
    <link rel="stylesheet" href="/naba.net/styles/pack6.css" type="text/css">
    <link rel="stylesheet" href="/naba.net/styles/standard.css" type="text/css">
    <link rel="stylesheet" href="/naba.net/styles/site.css" type="text/css">
