<DIV class="content">
<form name="Login" action="/login/register.php" method="post">
   ...
   <table class="loginbox" cellpadding=5>
     ...
     <tr>  
      ...
      <tr>  
         ...
         <td>
            <select name="Account">
               <option value="Pending" <?=($Account=='Pending'?' Selected':'')?>>Pending</option>
               <option value="Tutor" <?=($Account=='Tutor'?' Selected':'')?>>Tutor</option>
               <option value="Pending" <?=($Account=='Manager'?' Selected':'')?>>Manager</option>
               <option value="Pending" <?=($Account=='Admin'?' Selected':'')?>>Admin</option>
            </select>
         </td>
         <td align=right>
