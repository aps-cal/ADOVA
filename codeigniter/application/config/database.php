...
$db['world']['username'] = 'world-user';
$db['world']['password'] = '2cQSZEM6jWPeBpCG';
...
$db['default']['hostname'] = 'db423257347.db.1and1.com';
$db['default']['username'] = 'dbo423257347';
$db['default']['password'] = 'TimKelly';
$db['default']['database'] = 'db423257347';
