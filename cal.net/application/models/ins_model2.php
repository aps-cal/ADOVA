...
//         echo var_dump("RAW[".$xmlHttpRequest->getRawRequestMessage()."]");
      ...
      foreach($doc->getElementsByTagName('submission') as $submission ){
         ...
         if(!$row){
            ...
            $sql = "INSERT INTO ins_submissions ("
               ...
               ."Status, Email, Skills_Reqd, Skills, English_Level, Attendance, "
   ...
   public function GetStudents($data){
      ...
      $sql = "INSERT INTO ins_students ( "
        ...
        ."   Department, Skills_Reqd, Skills, English_Level, Attendance, Referrer,"
        ...
        ."   S.Department, S.Skills_Reqd, S.Skills, S.English_Level, S.Attendance, S.Referrer, "
